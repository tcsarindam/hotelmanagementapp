...
MPHB.BillingSection = can.Control.extend( {}, {
	...
	updateBillingInfo: function( el, e ) {
		var self = this;
...
MPHB.StripeGateway = MPHB.Gateway.extend(
    {},
    {
        ...
        confirmCardPayment: function(paymentIntent) {
            return this.api.confirmCardPayment(
        ...
        completeSourcePayment: function (source) {
            ...
            // The source object for SEPA Debit payment doesn't contain redirect.url property
...
MPHB.RoomTypeData = can.Construct.extend( {}, {
         ...
         * @returns {Boolean}
         */
        canCheckInDirect: function( date ) {
         ...
         * @returns {Boolean}
         */
        canCheckOutDirect: function( date ) {;
