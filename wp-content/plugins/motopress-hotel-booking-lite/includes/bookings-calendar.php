...
class BookingsCalendar {
	...
	public function __construct( $atts = array() ){
		$defaultAtts = array(
			...
			'custom_period_to'					 => new \DateTime( '+21 days' ),
		...
		<div class="mphb-bookings-calendar-filters-wrapper">
			...
			<form id="mphb-bookings-calendar-filters" method="get" class="wp-filter">
				...
				<div class="mphb-bookings-calendar-legend alignright">
					<legend class="legend-item booked" title="<?php _e( 'Booked', 'motopress-hotel-booking' ); ?>"><span><?php
						_e( 'Booked', 'motopress-hotel-booking' ); ?></span></legend>
					<legend class="legend-item pending" title="<?php _e( 'Pending', 'motopress-hotel-booking' ); ?>"><span><?php
						_e( 'Pending', 'motopress-hotel-booking' ); ?></span></legend>
					<legend class="legend-item external" title="<?php _e( 'External', 'motopress-hotel-booking' ); ?>"><span><?php
						_e( 'External', 'motopress-hotel-booking' ); ?></span></legend>
					<legend class="legend-item blocked" title="<?php _e( 'Blocked', 'motopress-hotel-booking' ); ?>"><span><?php
						_e( 'Blocked', 'motopress-hotel-booking' ); ?></span></legend>
				</div>
			</form>
		</div>
		<?php
	...
	private function renderRoomTypeSelect(){
		...
		<select id="mphb-bookings-calendar-filter-room-type"
			...
			<option <?php selected( $this->roomTypeId, self::ALL_ROOM_TYPES ); ?> value="<?php echo self::ALL_ROOM_TYPES; ?>" >
				<?php _e( 'All Accommodation Types', 'motopress-hotel-booking' ); ?>
			</option>
	...
	private function renderCustomPeriodFilter(){
		...
		<div class="mphb-custom-period-wrapper<?php echo $customPeriodWrapperClass; ?>">
			<input type="text" class="mphb-datepick mphb-custom-period-from mphb-date-input-width" name="<?php echo self::ATTS_FIELD_NAME; ?>[custom_period][date_from]" placeholder="<?php _e( 'From', 'motopress-hotel-booking' ); ?>" value="<?php echo $dateFrom; ?>" inputmode="none" />
			<input type="text" class="mphb-datepick mphb-custom-period-to mphb-date-input-width" name="<?php echo self::ATTS_FIELD_NAME; ?>[custom_period][date_to]" placeholder="<?php _e( 'Until', 'motopress-hotel-booking' ); ?>" value="<?php echo $dateTo; ?>" inputmode="none" />
		</div>
		<?php
	}
