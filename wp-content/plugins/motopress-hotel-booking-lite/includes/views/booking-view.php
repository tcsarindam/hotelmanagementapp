			...
			<table class="mphb-price-breakdown" cellspacing="0">
				...
				<tfoot>
					...
					<tr class="mphb-price-breakdown-subtotal">
						<td colspan="<?php echo ( $useThreeColumns ? 2 : 1 ); ?>">
							<?php echo __( 'Subtotal (excl. taxes)', 'motopress-hotel-booking' ); ?>
						</td>
						<td>
							<?php echo mphb_format_price( $priceBreakdown['total'] - $accommodationTaxesTotal - $feeTaxesTotal - $serviceTaxesTotal ); ?>
						</td>
					</tr>
					<tr class="mphb-tax-info-total">
						<td colspan="<?php echo ( $useThreeColumns ? 2 : 1 ); ?>">
							<?php echo __( 'Taxes', 'motopress-hotel-booking' ); ?>
						</td>
						<td>
							<?php
