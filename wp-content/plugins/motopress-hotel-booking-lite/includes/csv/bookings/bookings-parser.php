            ...
            foreach( $priceBreakdown['rooms'] as $key => $roomBreakdown ) {
                if( $key == $this->count ) {
                    if( isset( $roomBreakdown['taxes']['room']['total'] ) && $roomBreakdown['taxes']['room']['total'] > 0 ) {
                        $taxText = html_entity_decode(mphb_format_price($roomBreakdown['taxes']['room']['total'], array('as_html' => false)));
                    }
                    break;
                }
            }
            ...
            foreach( $priceBreakdown['rooms'] as $key => $roomBreakdown )
            {
                if( $key == $this->count ) {
                    if(isset($roomBreakdown['fees']['total']) && $roomBreakdown['fees']['total'] > 0) {
                        $taxText = html_entity_decode(mphb_format_price($roomBreakdown['fees']['total'], array('as_html' => false)));
                    }
                    break;
                }
            }
            ...
            foreach( $priceBreakdown['rooms'] as $key => $roomBreakdown )
            {
                if( $key == $this->count ) {
                    if(isset($roomBreakdown['taxes']['services']['total']) && $roomBreakdown['taxes']['services']['total'] > 0) {
                        $taxText = html_entity_decode(mphb_format_price($roomBreakdown['taxes']['services']['total'], array('as_html' => false)));
                    }
                    break;
                }
            }
            ...
            foreach( $priceBreakdown['rooms'] as $key => $roomBreakdown )
            {
                if( $key == $this->count ) {
                    if(isset($roomBreakdown['taxes']['fees']['total']) && $roomBreakdown['taxes']['fees']['total'] > 0) {
                        $taxText = html_entity_decode(mphb_format_price($roomBreakdown['taxes']['fees']['total'], array('as_html' => false)));
                    }
                    break;
                }
            }
