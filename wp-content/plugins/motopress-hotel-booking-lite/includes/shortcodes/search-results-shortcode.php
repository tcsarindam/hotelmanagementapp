		...
		<form action="<?php echo MPHB()->settings()->pages()->getCheckoutPageUrl(); ?>"
					...
					<li>
						...
						<div class="mphb-recommendation-item">
							<span class="mphb-recommedation-item-subtotal">
								...
								echo apply_filters( 'mphb_tmpl_the_room_type_price_for_dates',
                            ...
                            <?php if ( $guestsAllowed ) { ?>
                                <small class="mphb-recommendation-item-guests">
                                    ...
                                    <?php if ( $roomType->hasLimitedTotalCapacity() ) { ?>
                                        <span class="mphb-recommendation-item-total-capacity mphb-total-capacity-<?php echo $roomCapacity; ?>">
                                            <?php printf( _n( '%d guest', '%d guests', $roomCapacity, 'motopress-hotel-booking' ), $roomCapacity ); ?>
                                        </span>
                                    <?php } else if ( !$childrenAllowed ) { ?>
                                        <span class="mphb-recommendation-item-adults mphb-adults-<?php echo $roomAdults; ?>">
                                            <?php printf( _n( '%d guest', '%d guests', $roomAdults, 'motopress-hotel-booking' ), $roomAdults ); ?>
                                        </span>
                                    <?php } else { ?>
                                        <span class="mphb-recommendation-item-adults mphb-adults-<?php echo $roomAdults; ?>">
                                            <?php printf( _n( '%d adult', '%d adults', $roomAdults, 'motopress-hotel-booking' ), $roomAdults ); ?>
                                        </span>

                                        <?php if ( $roomChildren > 0 ) { ?>
                                            <span class="mphb-recommendation-item-adults-children-separator"><?php echo ', '; ?></span>
                                            <span class="mphb-recommendation-item-children mphb-children-<?php echo $roomChildren; ?>">
                                                <?php printf( _n( '%d child', '%d children', $roomChildren, 'motopress-hotel-booking' ), $roomChildren ); ?>
                                            </span>
                                        <?php } ?>
                                    <?php } ?>
                                </small>
			...
			<p	 class="mphb-recommendation-total">
				...
				<span class="mphb-recommendation-total-value">
					 ...
					 **/
					echo apply_filters( 'mphb_tmpl_the_total_recommended_price_for_dates',
