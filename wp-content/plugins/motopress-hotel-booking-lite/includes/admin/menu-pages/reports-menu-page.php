                ...
                <form id="mphb-export-bookings-form" class="mphb-export-form" method="POST">
					...
					<p>
						<fieldset>
							...
							<input name="start_date" class="mphb-datepick mphb-export-start-date" type="text" value="" placeholder="<?php echo esc_attr(__('Choose start date', 'motopress-hotel-booking')); ?>" autocomplete="off" inputmode="none" />
							<input name="end_date" class="mphb-datepick mphb-export-end-date" type="text" value="" placeholder="<?php echo esc_attr(__('Choose end date', 'motopress-hotel-booking')); ?>" autocomplete="off" inputmode="none" />
						</fieldset>
					</p>
                    <p>
