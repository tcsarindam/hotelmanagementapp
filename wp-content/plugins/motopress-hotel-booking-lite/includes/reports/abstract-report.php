            ...
            <div class="tablenav top">
                <div class="alignleft actions">
                    <form id="mphb-select-report-type" method="get">
                        ...
                        if( isset( $atts['range'] ) ) {
                            ?>
                            <input type="hidden" name="range" value="<?php echo $atts['range']; ?>">
                            <?php
                        }
                        ?>
                        <select id="mphb-report-types-list" name="report_type">
                            ...
                            foreach( $reportTypes as $reportType ) {
                                ?>
                                <option value="<?php echo esc_attr( $reportType['type'] ); ?>" <?php echo $this->reportType == $reportType['type'] ? 'selected="selected"' : ''; ?>><?php echo esc_attr( $reportType['description'] ); ?></option>
                                <?php
                            }
                            ?>
                        </select>
                        <input id="mphb-submit-report" class="button" type="submit" name="submit" value="<?php echo __( 'Show', 'motopress-hotel-booking' ); ?>">
                    </form>
                </div>
            </div>
            <?php
