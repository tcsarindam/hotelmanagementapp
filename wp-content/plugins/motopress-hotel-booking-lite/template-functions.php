...
function mphb_tmpl_the_room_reservation_form( $roomType = null ){
	...
	<form method="<?php echo esc_attr( $formMethod ); ?>" action="<?php echo esc_url( $actionUrl ); ?>" class="mphb-booking-form" id="<?php echo esc_attr( 'booking-form-' . $typeId ); ?>">
		...
		<p class="mphb-check-in-date-wrapper">
			...
			<br />
			<input id="<?php echo esc_attr( 'mphb_check_in_date-' . $uniqueSuffix ); ?>" type="text" class="mphb-datepick" value="<?php echo esc_attr( $checkInDateFormatted ); ?>" required="required" autocomplete="off" placeholder="<?php _e( 'Check-in Date', 'motopress-hotel-booking' ); ?>" inputmode="none" />
